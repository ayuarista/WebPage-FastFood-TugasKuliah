...
<body>
  ...
  <form action="result.php" method="get" enctype="multipart/form-data" class="navbar-form navbar-left">
    ...
    <div class="row" >
     ...
     <div id="sidebar_title"><h2> My account </h2></div>
    <ul id="cats">
    <?php 
    $user = $_SESSION['email_pemesan'];
    ...
    <li><a href="akun.php?my_profile"> My Profile </a> </li>
    <li><a href="akun.php?my_orders"> My order </a> </li>
    <li><a href="akun.php?edit_akun"> Edit Akun </a> </li>
    <li><a href="akun.php?ubah_pass"> Ubah Password </a> </li>
    <li><a href="akun.php?delete_akun"> Delete Akun </a> </li>
    ...
    <div class="col-md-10 col-sm-10 col-xs-11">
     ...
     <div id="produkbox">
      ...
      echo " <h2 style='padding:20px;'> Welcome:$nama_pemesan </h3><br>
      <br><br><br><br><br><br><br><br><br><br><br>
      <b> Order Progress bisa dilihat dengan meng-klik link ini <a href='akun.php?my_orders'> link </a> </b> 
      <br><br><br>";
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
     ...
     <h4>Menu</h4> 
    <h6><a href="main_menu.php"> Main Menu </a></h6> 
    <h6><a href="side_menu.php"> Side Menu </a></h6>
    <h6><a href="drink.php"> Drink </a></h6> 
    <h6><a href="snack.php">  Snack </a></h6>
