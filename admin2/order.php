...
$get_p = "SELECT * FROM admin2 where email_admin2='$user'";
$run_c = mysqli_query($con,$get_p);
$row_c = mysqli_fetch_array($run_c);
$c_id = $row_c['kode_admin2'];


  $get_pes= "SELECT * from pesanan where kode_admin='$c_id'";
  ...
  while ($row_pes=mysqli_fetch_array($run_pes)){
    ...
    $get_nama= "SELECT * FROM pemesan where id_pemesan='$pes_id'";
  ...
  <tr align="center">
    ...
    <td><?php echo $pes_total;?></td>
    <td><?php echo $pes_adm;?></td>
    <td><?php echo $pes_alamat;?></td>
    <td><?php echo $pes_kodepos;?></td>
    <td><a href="delete_orders.php?delete_orders=<?php echo $pes_hapus;?>">Delete</a></td>
  </tr>
  <?php }
