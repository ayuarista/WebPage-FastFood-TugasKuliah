...
<head>
    ...
    <title>Login Form - Lillah Admin Corner</title> 
...
<link rel="stylesheet" href="../../lillah/styles/login_style.css" media="all" />
    </head>
<body>
...
<div class="bg-1">
<div class="text-center"><font color="white">
...
<?php
    ...
    $sel_user = "SELECT* FROM admin2 WHERE email_admin2='$email_admin' AND pass_admin2='$password_admin'";
